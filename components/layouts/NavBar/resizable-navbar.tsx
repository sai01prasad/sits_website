...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn("fixed inset-x-0 top-10 z-100 w-full", className)}
    >
...
export const NavbarLogo = () => {
  ...
  const src = isDark ? "/SITS_h.svg" : "/SITS_h_l.svg";
  ...
  return (
    ...
    >
      <img src={src} alt="logo" width={120} />
    </a>
  );
};
...
export const DarkModeToggle = () => {
  ...
  return (
    <button
      ...
      onClick={toggle}
      className="flex items-center justify-center rounded-md p-2 text-sm text-neutral-700 hover:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-800"
    >
      {isDark ? (
